  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-menu" */ "../views/system/anime.vue"
          ),
      },
      //公告
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-announcement" */ "../views/system/announcement.vue"
          ),
      },
      //板块
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-section" */ "../views/system/section.vue"
          ),
      },
      {
        path: "/table",
